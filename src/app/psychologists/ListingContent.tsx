                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    {isLoading ? (
                        ...
                        <>
                                ...
                                <AnimatePresence>
                                    {paginatedPsychologists.map((psy, index) => (
                                        <motion.div
                                            ...
                                            className="group"
                                        >
                                            <article className="premium-card h-full bg-white border border-glass-border hover:border-primary/30 transition-all duration-300 hover:shadow-2xl hover:shadow-primary/5 flex flex-col overflow-hidden relative">
                                                ...
                                                <div className="p-6 pb-0 flex gap-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="flex items-center gap-1 text-yellow-500 text-sm font-bold" aria-label={`Puntuación de ${psy.rating}`}>
                            ...
                            {/* Pagination Controls */}
                            {totalPages > 1 && (
                                <nav className="flex justify-center items-center gap-2 mt-8" aria-label="Navegación de páginas">
                                    <Button
                                        variant="outline"
